      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-amber-500 mb-4">Java Lounge</h3>
            <p className="text-gray-300 mb-4">
              Experience the finest coffee and cuisine in Sri Lanka. A perfect blend of 
              comfort, quality, and exceptional service in the heart of Colombo.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Java Lounge. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
